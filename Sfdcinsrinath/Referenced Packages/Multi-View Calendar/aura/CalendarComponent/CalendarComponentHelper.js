({
    createCalendar : function(component,eventData) {
        ...
        var options = {
            tmpl_path: $A.get('$Resource.CalendarLib') + "/tmpls/",
            events_source:function () { return events; },
            view: 'month',
            tmpl_cache: false,
            hours:component.get("v.hours"),
            views:              {
                year:  {
                    slide_events: 1,
                    enable:       1
        ...
        var calendar = jQuery("#TC_calendar",":visible").calendar(options);
        ...
        jQuery('#first_day',":visible").change(function(){
        ...
        try{
            var mc = new Hammer(jQuery("#TC_calendar",":visible")[0]);
